...
Compilation options: -a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -ct 1 -cn multipink -es 1 -omp -mcd 16 -uim -double -ftz 0 -vec -lv 0 -vs 32
------------------------------------------------------------ */

#ifndef  __multipink_H__
#define  __multipink_H__
...
class multipink : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -ct 1 -cn multipink -es 1 -omp -mcd 16 -uim -double -ftz 0 -vec -lv 0 -vs 32");
		m->declare("filename", "multipink.dsp");
		...
		m->declare("name", "multipink");
		m->declare("noises.lib/name", "Faust Noise Generator Library");
		m->declare("noises.lib/version", "0.4");
		m->declare("vendor", "Giuseppe Silvi");
	}
	...
	virtual multipink* clone() {
		return new multipink();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("multipink");
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		#pragma omp parallel\
			firstprivate(output0_ptr, output1_ptr, output2_ptr, output3_ptr, iRec1, fRec0, fRec5, fRec6, fRec7)
		{
			for (int index = 0; index < count; index = index + 32) {
				FAUSTFLOAT* output0 = &output0_ptr[index];
				FAUSTFLOAT* output1 = &output1_ptr[index];
				FAUSTFLOAT* output2 = &output2_ptr[index];
				FAUSTFLOAT* output3 = &output3_ptr[index];
				int vsize = std::min<int>(32, count - index);
				#pragma omp single
				{
					/* Recursive loop 0 */
					/* Pre code */
					...
					for (int i = 0; i < vsize; i = i + 1) {
						iZec0[i] = 1103515245 * (iRec1[i - 1] + 12345);
						iZec1[i] = 1103515245 * (iZec0[i] + 12345);
						iZec2[i] = 1103515245 * (iZec1[i] + 12345);
						iRec1[i] = 1103515245 * (iZec2[i] + 12345);
						iRec2[i] = iZec2[i];
						iRec3[i] = iZec1[i];
						iRec4[i] = iZec0[i];
					}
				...
				#pragma omp sections
				{
					#pragma omp section
					{
						...
						/* Compute code */
						for (int i = 0; i < vsize; i = i + 1) {
							fRec7[i] = 0.5221894 * fRec7[i - 3] + 4.656612875245797e-10 * double(iRec4[i]) + 2.494956002 * fRec7[i - 1] - 2.017265875 * fRec7[i - 2];
						}
						/* Post code */
					...
					#pragma omp section
					{
						...
						/* Compute code */
						for (int i = 0; i < vsize; i = i + 1) {
							fRec5[i] = 0.5221894 * fRec5[i - 3] + 4.656612875245797e-10 * double(iRec2[i]) + 2.494956002 * fRec5[i - 1] - 2.017265875 * fRec5[i - 2];
						}
						/* Post code */
					...
					#pragma omp section
					{
						...
						/* Compute code */
						for (int i = 0; i < vsize; i = i + 1) {
							fRec6[i] = 0.5221894 * fRec6[i - 3] + 4.656612875245797e-10 * double(iRec3[i]) + 2.494956002 * fRec6[i - 1] - 2.017265875 * fRec6[i - 2];
						}
						/* Post code */
					...
					#pragma omp section
					{
						...
						/* Compute code */
						for (int i = 0; i < vsize; i = i + 1) {
							fRec0[i] = 0.5221894 * fRec0[i - 3] + 4.656612875245797e-10 * double(iRec1[i]) + 2.494956002 * fRec0[i - 1] - 2.017265875 * fRec0[i - 2];
						}
						/* Post code */
				...
				#pragma omp sections
				{
					#pragma omp section
					{
						...
						/* Compute code */
						for (int i = 0; i < vsize; i = i + 1) {
							output3[i] = FAUSTFLOAT(4.0 * (0.049922035 * fRec7[i] + 0.050612699 * fRec7[i - 2] - (0.095993537 * fRec7[i - 1] + 0.004408786 * fRec7[i - 3])));
						}
					}
					#pragma omp section
					{
						...
						/* Compute code */
						for (int i = 0; i < vsize; i = i + 1) {
							output1[i] = FAUSTFLOAT(4.0 * (0.049922035 * fRec5[i] + 0.050612699 * fRec5[i - 2] - (0.095993537 * fRec5[i - 1] + 0.004408786 * fRec5[i - 3])));
						}
					}
					#pragma omp section
					{
						...
						/* Compute code */
						for (int i = 0; i < vsize; i = i + 1) {
							output2[i] = FAUSTFLOAT(4.0 * (0.049922035 * fRec6[i] + 0.050612699 * fRec6[i - 2] - (0.095993537 * fRec6[i - 1] + 0.004408786 * fRec6[i - 3])));
						}
					}
					#pragma omp section
					{
						...
						/* Compute code */
						for (int i = 0; i < vsize; i = i + 1) {
							output0[i] = FAUSTFLOAT(4.0 * (0.049922035 * fRec0[i] + 0.050612699 * fRec0[i - 2] - (0.095993537 * fRec0[i - 1] + 0.004408786 * fRec0[i - 3])));
						}
					}
				}
			}
	...
	#define FAUST_FILE_NAME "multipink.dsp"
	#define FAUST_CLASS_NAME "multipink"
	#define FAUST_COMPILATION_OPIONS "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -ct 1 -cn multipink -es 1 -omp -mcd 16 -uim -double -ftz 0 -vec -lv 0 -vs 32"
 ...
 */
class multipink_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<multipink_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: multipink_poly will use and finally delete the pointer.
        ...
        virtual multipink_poly* clone()
        {
            return new multipink_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
struct dsp_poly_factory : public dsp_factory {
    ...
    {
        dsp_poly* dsp_poly = new multipink_poly(adaptDSP(fProcessFactory->createDSPInstance(), is_double), nvoices, control, group);
        if (fEffectFactory) {
...
void faust_allocate(t_faust* x, int nvoices)
{
    ...
    if (nvoices > 0) {
    ...
    #endif
        x->m_dsp = new multipink_poly(new multipink(), nvoices, true, true);
    #ifdef POLY2
        ...
        x->m_dsp = createSRAdapter<FAUSTFLOAT>(new multipink(), DOWN_SAMPLING, UP_SAMPLING, FILTER_TYPE);
    }
...
void* faust_new(t_symbol* s, short ac, t_atom* av)
{
    ...
    multipink* tmp_dsp = new multipink();
